...
<head>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.0/js/bootstrap.min.js"></script>
	<link rel="stylesheet" type="text/css" href="../style/admanager.css">
...
<div class="row">
	<div class="col-md-8" id="form">
		<strong><b class="manager">Add Manager</b></strong>
		<form action="admanager.php" method="post">
			...
			<div class="form-group">
				...
				<select class="form-control text" name="officer_designation" required="">
...
{	 
	...
	$address = mysqli_real_escape_string($conn, $_POST['address']);
		...
		$sql = "INSERT INTO `admin_add_manger`(`username`,`password`,`email`,`mobile_no`,`date_of_birth`,`gender`,`officer_designation`,`city`,`address`) VALUES ('$username','$password','$email','$mobile_no','$date_of_birth','$gender','$officer_designation','$city','$address')";
		...
		{
			echo "<script>alert('Manager Register successfully.')</script>";
