...
<head>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.0/js/bootstrap.min.js"></script>
	<link rel="stylesheet" type="text/css" href="../style/adwperson.css">
</head>
<body>
<!---------------------------create navbar------------------------->
...
<div class="row">
	<div class="col-md-8" id="form">
		...
		<form action="adwperson.php" method="post" enctype="multipart/form-data">
...
// Check if image file is a actual image or fake image
    ...
    // if everything is ok, try to upload file
		...
		$sql = "INSERT INTO `admin_add_wantedperson`( `name`, `age`, `gender`, `address`,`skin_tone`,`hair`, `body_type`, `height`,`crime_description`,`image`) VALUES ('$name','$age','$gender','$address','$skin_tone','$hair','$body_type','$height','$crime_description','$image')";
