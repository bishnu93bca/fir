...
<head>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.0/js/bootstrap.min.js"></script>
	<link rel="stylesheet" type="text/css" href="../style/adrinvestigation.css">
</head>
<body>
	<!---------------------------create navbar------------------------->
...
<!------------------------------------------receive investigation data------------------->
<?php
include_once("../config.php");
$sql="SELECT * FROM subadmin_add_investigation";
		...
		<?php 
				  while($row=mysqli_fetch_array($result))
				  {
      				...
      				<tr>
            			...
            			<td>
            				<a href="admin_panel.php" class="btn btn-success btn-sm view-btn" data-id="<?php echo $ids;?>">View</a>
            				<a href="admin_reply_investigation.php?id=<?php echo $ids;?>" class="btn btn-success btn-sm update-btn">update</a></td>
            				</tr>
				  <?php
				}
?>
