...
<head>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.0/js/bootstrap.min.js"></script>
	<link rel="stylesheet" type="text/css" href="../style/adlogin.css">
</head>
<body>
	<!--------------------------creation navbar---------------------->
...
<!-------------------------------Admin Login Form--------------------------------------->
	...
	<div class="container">
		<div class="row">
			<div class="col-md-6" id="form">
				<center><b class="AdminLogin">Admin Login</b></center>
				<form action="" method="post">
					<div class="form-group">
				<label>Email:</label>
				<input type="text" name="user_email" class="form-control text" placeholder="Enter Email ">
			</div>
			<div class="form-group">
	...
	if(isset($_POST['submit']))
	{
		...
		$sql="SELECT * FROM admin_login WHERE user_email='$user_email' AND password='$password'";
		$result= mysqli_query($conn,$sql);
		$num=mysqli_fetch_array($result);
		
		if(!isset($num['admin_id']))
		     {
			...
			else
		    {
		    	...
		    	$_SESSION['admin_email'] = $num['user_email']; 
