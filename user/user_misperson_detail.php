...
<html>
<head>
	<title>User Miss Person Detail</title>
	<meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.0/css/bootstrap.min.css">
  <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.0/js/bootstrap.min.js"></script>
  <link rel="stylesheet" type="text/css" href="../style/umissdetail.css">
</head>
<body>
	<!----------------------------create navbar---------------------->
...
session_start();
	...
	$id=$_SESSION['id'];
	$sql="SELECT * FROM user_registration JOIN user_add_misperson ON id=user_id WHERE user_registration.id=$id";
    ...
    <table class="table table-bordered table-striped table-hover table-mc-light-blue">
    	<h1>Your Miss Person Complain</h1>
    <thead>
    	<tr>
	...
	<tbody>
		<?php 
				  while($row=mysqli_fetch_array($result))
				  {
					...
					echo "<td>".$row['skin_tone']."</td>";
					echo "<td>".$row['height']."</td>";
					echo "<td>".$row['hair']."</td>";
					echo "<td>".$row['body_type']."</td>";
					echo "<td>".$row['mental_ability']."</td>";
					echo "<td>".$row['missing_date']."</td>";
