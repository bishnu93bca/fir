...
//stor the values in variables
	...
	$address = mysqli_real_escape_string($conn, $_POST['address']);	
		...
		$sql1 = "INSERT INTO `user_reg`(`username`,`fname`,`cnic`,`password`,`email`,`mobile_no`,`date_of_birth`,`gender`,`city`,`address`) VALUES ('$username','$fname','$cnic','$password','$email','$mobile_no','$date_of_birth','$gender','$city','$address')";
		$sql2 = "INSERT INTO `user_note`(`username`,`fname`,`cnic`,`password`,`email`,`mobile_no`,`date_of_birth`,`gender`,`city`,`address`,`read_n`) VALUES ('$username','$fname','$cnic','$password','$email','$mobile_no','$date_of_birth','$gender','$city','$address','1')";
