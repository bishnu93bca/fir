        ...
        <div class="col-md-8" id="form">
            ...
            <form action="" method="post">
                <div class="form-group">
                    ...
                    <input type="text" name="serial_no" class="form-control text" placeholder="" required="">
                </div>
                <div class="form-group">
                    <label>Form No.</label>
                    <input type="text" name="form_no" class="form-control text" placeholder="" required="">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="officer_name" class="form-control text" placeholder="Officer Name" required="">
                </div>
                <div class="form-group">
                    <label>Belt No.</label>
                    <input type="number" name="belt_no" class="form-control text" placeholder="" required="">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label>Sign.</label>
                    <input type="Number" name="sign" class="form-control text" placeholder="" required="">
                </div>
                <div class="form-group">
...
if(isset($_POST['submit']))
 {   
    ...
    $sign = mysqli_real_escape_string($conn, $_POST['sign']);     
        ...
        $sql = "INSERT INTO `subadmin_add_fir`(`serial_no`,`form_no`,`police_station`,`e_tag_no`,`complain_date`,`police_date`,`complainer_detail`,`crime_condition`,`police_station_distance`,`delay_reason`,`officer_name`,`belt_no`,`designation`,`fir_detail`,`sign`) VALUES ('$serial_no','$form_no','$police_station','$e_tag_no','$complain_date','$police_date','$complainer_detail','$crime_condition','$police_station_distance','$delay_reason','$officer_name','$belt_no','$designation','$fir_detail','$sign')";
