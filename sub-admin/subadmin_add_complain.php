...
<html>
<head>
	<title>Sub Admin Add User Complaint</title>
	<meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.0/css/bootstrap.min.css">
  <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.0/js/bootstrap.min.js"></script>
  <link rel="stylesheet" type="text/css" href="../style/sbcomplain.css">
</head>
<body>
			...
			<nav class="navbar  navbar-default">
				...
				<div class="collapse navbar-collapse" id="FIR">
					<ul class="nav navbar-nav pull-left">
					    ...
					    <li><a href="../user/usignin.html">Sign In</a></li>
						<li><a href="../user/ureg.html">Sign Up</a></li>
        <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#" style="color: white;">Login<span class="caret"></span></a>
					<ul class="dropdown-menu">
						<li><a href="../Admin/adlogin.html">Admin</a></li>
						<li><a href="sbadminlogin.html">Sub Admin</a></li>
	...
	<div class="col-md-8" id="form">
		...
		<form action="" method="post">
			...
			<div class="form-group">
				...
				<input type="radio" name="visit" onclick="show2()" value="Y" required=""><b>Yes</b>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<input type="radio" name="visit" onclick="show1()" value="N" required=""><b>No</b>
			</div>
