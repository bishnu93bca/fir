...
include_once('../config.php');
	session_start();
	if (empty($_SESSION['manager_id']) || empty($_SESSION['email'])) 
	{
		header("Location : subadmin_login.php");
	}
	///////session complete//////////////////////////////////
	////////////receive complain notification//////////////////
    if (isset($_GET['notf']))
   {
     $n_id=$_GET['notf'];
     $conn->query("UPDATE user_complain_notification set read_n='0' WHERE id='$n_id'");
     header("location:subadmin_receive_complain.php");
   }
    if (isset($_POST['data'])) 
	{
    ...
    $count=mysqli_num_rows($new_data);	
	 ...
	 //////////////////// receive investigation report notification///////////////////
	 if (isset($_POST['data'])) 
	{
	...
	$data=$conn->query("SELECT * FROM subadmin_receive_notification");
...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="../style/sbadpenel.css"/> 
</head>
<body>
	<!-------------------------createnavbar-------------------------------->
...
<!--------------------Sub admin Panel---------------------------------------->
<a class="mobile" href=""> Sub Admin Menu</a>
<div id="container">
	<div class="sidebar">
		<ul id="nav">
			<!-------------notification1------------------------->
			<div class="dropdown">
		 	<a href="subadmin_receive_complain.php" class="btn btn-primary dropdown-toggle">
  ...
  <ul class="dropdown-menu">
    ...
    <?php
  	...
  	?>
		 ...
		 <li><a href="subadmin_mark_complain.php">Mark Complain </a></li>
		  <li><a href="subadmin_send_message.php">Send Message</a></li>
		  <!--------------------notification2--------------------------------------->
		<div class="dropdown">
		 	<a href="subadmin_receive_investigation.php" class="btn btn-primary dropdown-toggle">
  ...
  <ul class="dropdown-menu">
    ...
    <?php
  	...
  	?>
		...
		<li><a href="subadmin_add_investigation.php">Add Investigation Report</a></li>
		<li><a href="subadmin_add_fir.php">Add FIR </a></li>
		<li><a href="subadmin_view_firs.php">View FIR</a></li>
		<li><a href="subadmin_view_complain.php">View Complains</a></li>
		<li><a href="subadmin_add_complain.php">Add Complains</a></li>
		<li><a href="subadmin_add_misperson.php">Add Missing Person</a></li>
		<li><a href="subadmin_add_wantedperson.php">Add Most Wanted Criminal </a></li>
		<li><a href="subadmin_change_password.php">Change Password</a></li>
