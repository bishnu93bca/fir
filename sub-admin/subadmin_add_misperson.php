...
<head>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.0/js/bootstrap.min.js"></script>
	<link rel="stylesheet" type="text/css" href="../style/sbmisperson.css">
</head>
<body>
<!---------------------------create navbar------------------------->
...
<!----------------------------------subadmin add Misperson php code------------------->
<?php
...
if(isset($_POST['submit']))
{
	...
	////image insert into database and sbadminuploads
...
// Check if image file is a actual image or fake image
    ...
    // if everything is ok, try to upload file
		...
		$sql = "INSERT INTO `subadmin_add_misperson`(`police_station`,`name`,`age`,`gender`,`skin_tone`,`height`,`hair`,`body_type`,`mental_ability`,`wearing`,`missing_date`,`image`) VALUES ('$police_station','$name','$age','$gender','$skin_tone','$height','$hair','$body_type','$mental_ability','$wearing','$missing_date','$image')";
